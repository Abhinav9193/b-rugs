...
3. **02. Manufacturing Process**: Large interactive player showcasing all 5 manufacturing stages (_Design & Development, Yarn Preparation, Weaving, Finishing & Care, Packing & Dispatch_) driven by Embla Carousel.
4. **03. Sustainability**: 5-stage editorial row presentation highlighting mindful practices (_Natural Materials, Responsible Sourcing, Conscious Processes, Reducing Waste, Built to Last_).
