...
export const SITE_CONFIG = {
  ...
  description: 'Bunaai Rugs combines traditional craftsmanship with modern manufacturing to create rugs for wholesale, retail, design and business requirements.',
  url: 'https://www.bunaairugs.com/',
};

export const NAV_ITEMS = [
  { id: 'heritage', label: 'OUR HERITAGE', href: '#heritage' },
  { id: 'manufacturing', label: 'MANUFACTURING PROCESS', href: '#manufacturing' },
  { id: 'sustainability', label: 'SUSTAINABILITY', href: '#sustainability' },
  { id: 'contact', label: 'CONTACT', href: '#contact' },
];

export const SOCIAL_LINKS = [
  { name: 'Instagram', url: 'https://www.instagram.com/bunaairugs/', icon: 'instagram' },
  { name: 'Facebook', url: 'https://www.facebook.com/bunaairugs/', icon: 'facebook' },
  { name: 'Pinterest', url: 'https://www.pinterest.com/bunaairugs/', icon: 'pinterest' },
