...
import { sustainabilitySteps, SUSTAINABILITY_PAGE_COPY } from '../data/sustainabilitySteps';
  ...
  return (
    <section id="sustainability" className="sustainability-section">
      <div className="container">
        ...
        <div className="sustainability-header">
          <div className="sustainability-header__left">
            <span className="section-label">{SUSTAINABILITY_PAGE_COPY.eyebrow}</span>
      ...
      <div className="sustainability-floating-badge" aria-hidden="true">
        <span className="sust-v-text">{SUSTAINABILITY_PAGE_COPY.verticalMotif.line1}</span>
        ...
        <div className="sust-v-line" />
        <span className="sust-v-text">{SUSTAINABILITY_PAGE_COPY.verticalMotif.line2}</span>
      </div>
    </section>
  );
}
