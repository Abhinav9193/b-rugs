...
export default function Testimonials() {
  ...
  return (
    ...
    >
      <div
        className="testimonials-glow-orb testimonials-glow-orb--left"
        aria-hidden="true"
      />
      <div
        className="testimonials-glow-orb testimonials-glow-orb--right"
        aria-hidden="true"
      />
      ...
      <div className="container">
        <div className="testimonials-header">
          ...
          <div className="testimonials-header__status">
            ...
            <span className="testimonials-live-text">
              {PARTNERS_PAGE_COPY.badge}
            </span>
          </div>
        </div>
      ...
      >
        <div
          className="testimonials-edge-fade testimonials-edge-fade--left"
          aria-hidden="true"
        />
        <div
          className="testimonials-edge-fade testimonials-edge-fade--right"
          aria-hidden="true"
        />
          ...
          {infinitePartners.map((partner, idx) => (
            <div key={`${partner.id}-${idx}`} className="partner-card">
              ...
              <div className="partner-card__logo-area">
                <span
                  className={`partner-card__brand-name ${partner.fontClass}`}
                >
                  {partner.name}
                </span>
              </div>
      ...
      <div className="testimonials-floating-badge" aria-hidden="true">
        <span className="test-v-text">
          {PARTNERS_PAGE_COPY.verticalMotif.line1}
        </span>
        ...
        <div className="test-v-line" />
        <span className="test-v-text">
          {PARTNERS_PAGE_COPY.verticalMotif.line2}
        </span>
      </div>
    </section>
  );
