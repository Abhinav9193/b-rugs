...
const FOOTER_PAGE_COPY = {
  ...
  wholesaleText: 'We partner with retailers, designers and businesses for custom and bulk rug requirements.',
...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="footer">
      ...
      <div className="footer__glow-orb footer__glow-orb--left" aria-hidden="true" />
      <div className="footer__glow-orb footer__glow-orb--right" aria-hidden="true" />
        ...
        <div className="footer__grid">
          ...
          <div className="footer__col footer__col--brand">
            <div className="footer__brand-header">
              <a href="/" className="footer__logo" aria-label="Bunaai Rugs - Home">
                <img
            ...
            <p className="footer__brand-statement">
              {FOOTER_PAGE_COPY.brandStatement.line1}<br />
              {FOOTER_PAGE_COPY.brandStatement.line2}<br />
            ...
            <div className="footer__craft-card">
              ...
              <div className="footer__craft-footer">
                <div className="footer__craft-info">
                  <span className="footer__craft-location">HAND-KNOTTED ATELIER</span>
                  <span className="footer__craft-sub">Century-old loom artistry</span>
                </div>
                <div className="footer__craft-motif" aria-hidden="true">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <rect x="4" y="4" width="16" height="16" transform="rotate(45 12 12)" stroke="currentColor" fill="none" />
                  </svg>
                </div>
              </div>
            </div>
          ...
          <div className="footer__col footer__col--nav">
            <h4 className="footer__col-title">{FOOTER_PAGE_COPY.navigationTitle}</h4>
            ...
            <ul className="footer__nav-list">
              {NAV_ITEMS.map((item) => (
                <li key={item.id} className="footer__nav-item">
                  ...
                  >
                    {item.label === 'OUR HERITAGE' ? 'Our Heritage' :
                     item.label === 'MANUFACTURING PROCESS' ? 'Manufacturing Process' :
                     item.label === 'SUSTAINABILITY' ? 'Sustainability' :
                     item.label === 'WHOLESALE' ? 'Wholesale' : 'Contact'}
                  </a>
                </li>
              ))}
            </ul>
          ...
          <div className="footer__col footer__col--wholesale">
            <h4 className="footer__col-title">{FOOTER_PAGE_COPY.wholesaleTitle}</h4>
            <div className="footer__col-title-line" />
          ...
          <div className="footer__col footer__col--contact">
            <h4 className="footer__col-title">{FOOTER_PAGE_COPY.contactTitle}</h4>
            <div className="footer__col-title-line" />
            <ul className="footer__contact-list">
              ...
              <li className="footer__contact-item">
                ...
                <div className="footer__contact-phones">
                  <a href={`tel:${CONTACT_INFO.phone1Raw}`} className="footer__contact-link">
                    {CONTACT_INFO.phone1}
                  </a>
                  <a href={`tel:${CONTACT_INFO.phone2Raw}`} className="footer__contact-link">
                    {CONTACT_INFO.phone2}
                  </a>
                </div>
              </li>
          ...
          <div className="footer__col footer__col--social">
            <h4 className="footer__col-title">{FOOTER_PAGE_COPY.socialTitle}</h4>
            <div className="footer__col-title-line" />
